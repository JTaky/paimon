...
public class StoreSinkWriteImpl implements StoreSinkWrite {
    ...
    StoreSinkWriteImpl(
        ...
        // Not in newTableWrite: replace() rebuilds it on schema evolution, resetting the counter.
        this.rowsWritten =
                metricGroup == null
                        ? null
     ...
     * row-kind filter drops. In every overload because they do not delegate to each other.
     *
